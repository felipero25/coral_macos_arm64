...
## Uso rápido (con el binario precompilado)

Requiere Homebrew con `libusb` y `abseil` instalados (el dylib enlaza abseil de
Homebrew por ruta absoluta — ver *Notas*).
...
# Descargar datos de prueba si no están (ver testdata/), luego:
...
dist/                       libedgetpu.1.dylib compilado
